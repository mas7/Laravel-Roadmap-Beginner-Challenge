                                    ...
                                    <div class="inline-block relative w-full">
                                        <div class="flex flex-col items-center relative">
                                            <div x-on:click="open" class="w-full">
                                                <div
                                                    class="my-2 p-1 flex border shadow-sm border-gray-300 bg-white rounded-md">
                                           ...
                                           C14.817,13.62,14.817,14.38,14.348,14.849z" />
                                                    ...
                                                    <div
                                                        class="text-gray-300 w-8 py-1 pl-2 pr-1 flex items-center border-gray-200 svelte-1l8159u">
